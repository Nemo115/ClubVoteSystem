...
#CREATE ELECTION
@app.route('/app/api/v1/election/create', methods=["POST", "GET"])
def create_election():
    return {}

#SUBMIT VOTE
@app.route('/app/api/v1/votes/submit', methods=["POST", "GET"])
def submit_vote():
    return {}

#VERIFY VOTER EMAIL
@app.route('/app/api/v1/votes/verify', methods=["POST", "GET"])
def verify_vote():
    return {}
